...
function BuyerManageProducts() {
  ...
  // Generate PDF report
  const generatePDF = () => {
    const input = document.getElementById('inventory-table'); // The table ID you want to capture
    html2canvas(input).then((canvas) => {
      ...
      doc.setFontSize(18);
      doc.text('AgroVista Inventory Report', 14, 20);

      // Add description or website name
      doc.setFontSize(12);
      doc.text('Generated by AgroVista', 14, 30);

      // Add the captured table image to the PDF
      doc.addImage(imgData, 'PNG', 10, 40, 180, 160); // Adjusted position and size
