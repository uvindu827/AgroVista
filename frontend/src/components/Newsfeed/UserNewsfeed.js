  ...
  return (
    <div className="min-h-screen bg-green-100 p-6">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-4xl font-semibold text-center text-green-800 mb-6">
          News Feed
        </h1>
        ...
        <div className="mb-6 max-w-md mx-auto">
          <div className="relative flex items-center">
            <input
              ...
              className="w-full px-4 py-2 border border-green-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 placeholder-green-400"
            />
            {searchTerm && (
              <button 
                onClick={clearSearch}
